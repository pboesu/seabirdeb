...
system.time(out <- ode(states, times, func = "d_teix_simple_full_life", parms = c(params[1:10], t_x = 300, L_m_a = 17.8, f_a = 0.8) , dllname = "seabirdeb", initfunc = "init_teix_simple_full_life", nout = 2, outnames = c("L_cul", "Ww")))
plot(out, obs=obs_long, which = 1:6)
