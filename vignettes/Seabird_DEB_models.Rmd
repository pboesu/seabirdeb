...
states_logfood['f_n'] = 1.4
system.time(out3 <- ode(states_logfood, times, func = "d_logfood", parms = params[1:10], dllname = "seabirdeb", initfunc = "init_logfood", nout = 2, outnames = c("L_cul", "Ww")))
plot(out3, obs=obs_long, which = c(4,2:3,1))
